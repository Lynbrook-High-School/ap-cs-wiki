...
> ![Complete Binary Tree](/static/images/heaps/complete_tree.png)
> 
> And this is **not** a complete binary tree:
> ![Binary Tree](/static/images/heaps/binary_tree.png)
...
Note that this indexing assumes that our root node is $0$.

This allows us to implement a heap as an array (typically an `ArrayList`).
