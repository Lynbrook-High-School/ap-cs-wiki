...
<video width="960" height="720" controls>
    <source src="/static/objects/videos/ref69.mp4" type="video/mp4"/>
</video>
...
<video width="960" height="720" controls>
	<source src="/static/objects/videos/ref2.mp4" type="video/mp4"/>
</video>
...
we use `this("fido", age)` and not `Dog("fido", age)`. As mentioned earlier, 
the `this` keyword tells Java that we are referring to our current object.
